(function () { 
    window.addEventListener("load", function () {
        setTimeout(function () {
            ...
            // Section 02 - Set logo
            logo[0].children[0].alt = "Touchless";
            logo[0].children[0].src = "/swagger-ui/resources/t_l_logo.png";
            logo[0].children[0].style.height = "50px";
            logo[0].children[0].style.width = "240px";

            logo[0].children[1].remove();
